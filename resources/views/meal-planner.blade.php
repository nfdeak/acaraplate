...
<div class="mx-auto my-8 max-w-6xl px-4 sm:px-6 lg:px-8">
    ...
    <section class="mb-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <h3 class="text-lg font-semibold text-slate-900">Grocery Lists</h3>
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <h3 class="text-lg font-semibold text-slate-900">Progress Tracking</h3>
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <h3 class="text-lg font-semibold text-slate-900">Open Source</h3>
    ...
    <section class="border-t border-slate-200 pt-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <a href="{{ route('spike-calculator') }}" class="group flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-orange-300 hover:bg-orange-50">
            ...
            <a href="{{ route('snap-to-track') }}" class="group flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-blue-300 hover:bg-blue-50">
            ...
            <a href="{{ route('tools.index') }}" class="group flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-emerald-300 hover:bg-emerald-50">
