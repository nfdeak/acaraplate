...
export function SafetyNote({ props }: { props: { title: string; body: string; items: string[] } }) {
    return (
        <section className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/80">
            <div className="flex gap-3">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-slate-600 dark:text-slate-300">{props.body}</p>
